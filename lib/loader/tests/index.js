...
function testInstantiate(file) {
  ...
  (async () => {
    const { exports, instance, module } = await loader.instantiate(new WebAssembly.Module(fs.readFileSync(__dirname + "/build/" + file)), {});
    assert(exports.memory);
    assert(instance && instance instanceof WebAssembly.Instance);
    assert(module && module instanceof WebAssembly.Module);
  })();
  ...
  (async () => {
    const { exports, instance, module } = await loader.instantiateStreaming(wrapToResponse(fs.promises.readFile(__dirname + "/build/" + file)), {});
    assert(exports.memory);
    assert(instance && instance instanceof WebAssembly.Instance);
    assert(module && module instanceof WebAssembly.Module);
  })();

...
export class Compiler extends DiagnosticEmitter {
  ...
  compile(): Module {
    ...
    if ((this.runtimeFeatures & RuntimeFeatures.Data) != 0 || hasShadowStack) {
      if (options.isWasm64) {
        module.addGlobal(BuiltinNames.data_end, TypeRef.I64, false, module.i64(i64_low(memoryOffset), i64_high(memoryOffset)));
      } else {
    ...
    if ((this.runtimeFeatures & RuntimeFeatures.Stack) != 0 || hasShadowStack) {
      ...
      if (options.isWasm64) {
        module.addGlobal(BuiltinNames.stack_pointer, TypeRef.I64, true, module.i64(i64_low(memoryOffset), i64_high(memoryOffset)));
      } else {
    ...
    if ((this.runtimeFeatures & RuntimeFeatures.Heap) != 0 || hasShadowStack) {
      if (options.isWasm64) {
        module.addGlobal(BuiltinNames.heap_base, TypeRef.I64, false, module.i64(i64_low(memoryOffset), i64_high(memoryOffset)));
      } else {
    ...
    if (!startIsEmpty || exportStart != null) {
      ...
      if (exportStart == null) module.setStart(funcRef);
        ...
        if (!isIdentifier(exportStart) || module.hasExport(exportStart)) {
          this.error(DiagnosticCode.Start_function_name_0_is_invalid_or_conflicts_with_another_export, Source.native.range, exportStart);
        } else {
  ...
  private initDefaultMemory(memoryOffset: i64): void {
    ...
    if (lowMemoryLimit32) {
      ...
      if (i64_gt(memoryOffset, lowMemoryLimit)) {
        this.error(DiagnosticCode.Low_memory_limit_exceeded_by_static_data_0_1, null, i64_to_string(memoryOffset), i64_to_string(lowMemoryLimit));
      }
    }
    ...
    if (options.importMemory) {
      module.addMemoryImport(CommonNames.DefaultMemory, ImportNames.DefaultNamespace, ImportNames.Memory, isSharedMemory);
    }
  }
  ...
  private initDefaultTable(): void {
    ...
    module.addFunctionTable(CommonNames.DefaultTable, initialTableSize, maximumTableSize, functionTableNames, module.i32(tableBase));
  }
  ...
  private compileModuleExport(name: string, element: DeclaredElement, prefix: string = ""): void {
          ...
          if (functionInstance.is(CommonFlags.Compiled)) {
            ...
            if (!module.hasExport(exportName)) {
              ...
              if (!this.desiresExportRuntime) {
                ...
                if ((thisType && lowerRequiresExportRuntime(thisType)) || liftRequiresExportRuntime(signature.returnType)) {
        ...
        if (global.is(CommonFlags.Compiled)) {
          ...
          if (!module.hasExport(exportName)) {
            ...
            if (!this.desiresExportRuntime) {
              ...
              if (liftRequiresExportRuntime(type) || (!global.is(CommonFlags.Const) && lowerRequiresExportRuntime(type))) {
                this.desiresExportRuntime = true;
              }
            }
          }
    ...
    this.warning(DiagnosticCode.Only_variables_functions_and_enums_become_WebAssembly_module_exports, element.identifierNode.range);
  }
  ...
  compileGlobalLazy(global: Global, reportNode: Node): bool {
    ...
    this.errorRelated(DiagnosticCode.Variable_0_used_before_its_declaration, reportNode.range, global.identifierNode.range, global.internalName);
    return false;
  }
  ...
  compileGlobal(global: Global): bool {
    ...
    if (!global.is(CommonFlags.Resolved)) {
      ...
      if (typeNode) {
        ...
        if (this.currentType == Type.void) {
          this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, initializerNode.range, this.currentType.toString(), "<auto>");
          global.set(CommonFlags.Errored);
          pendingElements.delete(global);
          return false;
        }
    ...
    //   }
    //   bar();
    if (!initializerNode && !global.is(CommonFlags.DefinitelyAssigned) && type.isReference && !type.isNullableReference) {
      this.error(DiagnosticCode.Initializer_definitive_assignment_or_nullable_type_expected, global.identifierNode.range);
    }
    ...
    if (global.is(CommonFlags.Ambient)) {
      ...
      if (isDeclaredConstant || this.options.hasFeature(Feature.MutableGlobals)) {
        ...
        module.addGlobalImport(global.internalName, mangleImportName_moduleName, mangleImportName_elementName, typeRef, !isDeclaredConstant);
        pendingElements.delete(global);
    ...
    if (initializerNode) {
      if (!initExpr) {
        ...
        initExpr = this.compileExpression(initializerNode, type, Constraints.ConvImplicit | Constraints.MustWrap | Constraints.PreferStatic);
        this.currentFlow = previousFlow;
      }
    ...
    if (initializeInStart) {
      ...
      if (isDeclaredInline) {
        this.error(DiagnosticCode.Decorator_0_is_not_valid_here, findDecorator(DecoratorKind.Inline, global.decoratorNodes)!.range, "inline");
      }
      ...
      for (let _values = Map_values(members), i = 0, k = _values.length; i < k; ++i) {
        ...
        if (valueNode) {
          ...
          if (getExpressionId(initExpr) != ExpressionId.Const) {
            ...
            if (precomp) {
              ...
              if (element.is(CommonFlags.Const)) {
                this.error(DiagnosticCode.In_const_enum_declarations_member_initializer_must_be_constant_expression, valueNode.range);
              }
              initInStart = true;
            }
          }
          ...
          if (isInline) {
            ...
            initExpr = module.binary(BinaryOp.AddI32, module.global_get(previousValue.internalName, TypeRef.I32), module.i32(1));
            let precomp = module.runExpression(initExpr, ExpressionRunnerFlags.PreserveSideeffects);
            if (precomp) {
              initExpr = precomp;
            } else {
              if (element.is(CommonFlags.Const)) {
                this.error(DiagnosticCode.In_const_enum_declarations_member_initializer_must_be_constant_expression, member.declaration.range);
              }
              initInStart = true;
            }
          }
  ...
  compileFunction(
    ...
    if (bodyNode) {
      ...
      if (instance.is(CommonFlags.Ambient)) {
        this.error(DiagnosticCode.An_implementation_cannot_be_declared_in_ambient_contexts, instance.identifierNode.range);
      }
      ...
      module.addFunctionImport(instance.internalName, mangleImportName_moduleName, mangleImportName_elementName, signature.paramRefs, signature.resultRefs);
      ...
      funcRef = module.addFunction(instance.internalName, signature.paramRefs, signature.resultRefs, null, module.unreachable());
    } else {
      ...
      if (instance.isAny(CommonFlags.Get | CommonFlags.Set)) {
        ...
        if (propertyInstance && propertyInstance.isField) {
          funcRef = instance.is(CommonFlags.Get) ? this.makeBuiltinFieldGetter(propertyInstance) : this.makeBuiltinFieldSetter(propertyInstance);
          assert(instance.is(CommonFlags.Compiled));
        }
      }
      if (!funcRef) {
        this.error(DiagnosticCode.Function_implementation_is_missing_or_not_immediately_following_the_declaration, instance.identifierNode.range);
  ...
  private compileFunctionBody(
    ...
    if (instance.is(CommonFlags.Constructor)) {
      ...
      if (flow.isAny(FlowFlags.AccessesThis | FlowFlags.ConditionallyAccessesThis) || !flow.is(FlowFlags.Terminates)) {
        ...
        if (flow.is(FlowFlags.MayReturnNonThis)) {
          if (this.options.pedantic) {
            this.pedantic(DiagnosticCode.Explicitly_returning_constructor_drops_this_allocation, instance.identifierNode.range);
          }
        }
      }
      ...
      if (flow.is(FlowFlags.MayReturnNonThis) && !classInstance.hasDecorator(DecoratorFlags.Final)) {
        this.error(DiagnosticCode.A_class_with_a_constructor_explicitly_returning_something_else_than_this_must_be_final, classInstance.identifierNode.range);
      }
      ...
      if (classInstance.base && !classInstance.prototype.implicitlyExtendsObject && !flow.is(FlowFlags.CallsSuper)) {
        this.error(DiagnosticCode.Constructors_for_derived_classes_must_contain_a_super_call, instance.prototype.declaration.range);
      }

      // if this is a normal function, make sure that all branches terminate
    } else if (returnType != Type.void && !flow.is(FlowFlags.Terminates)) {
      this.error(DiagnosticCode.A_function_whose_declared_type_is_not_void_must_return_a_value, instance.prototype.functionTypeNode.returnType.range);
  ...
  private makeBuiltinFieldGetter(property: Property): FunctionRef {
    ...
    let body = module.load(valueType.byteSize, valueType.isSignedIntegerValue, module.local_get(0, thisTypeRef), valueTypeRef, property.memoryOffset);
    ...
    return module.addFunction(getterInstance.internalName, thisTypeRef, valueTypeRef, typesToRefs(getterInstance.getNonParameterLocalTypes()), body);
  }
  ...
  private makeBuiltinFieldSetter(property: Property): FunctionRef {
    ...
    let bodyExpr = module.store(valueType.byteSize, module.local_get(0, thisTypeRef), module.local_get(1, valueTypeRef), valueTypeRef, property.memoryOffset);
    if (valueType.isManaged) {
      ...
      if ((<Class>parent).type.isManaged) {
        ...
        bodyExpr = module.block(
          ...
          [
            bodyExpr,
            module.call(linkInstance.internalName, [module.local_get(0, thisTypeRef), module.local_get(1, valueTypeRef), module.i32(0)], TypeRef.None),
          ],
          TypeRef.None,
        );
      }
    ...
    return module.addFunction(setterInstance.internalName, createType([thisTypeRef, valueTypeRef]), TypeRef.None, null, bodyExpr);
  }
  ...
  private compileTypeDeclaration(statement: TypeDeclaration): ExpressionRef {
    ...
    if (existedTypeAlias) {
      this.errorRelated(DiagnosticCode.Duplicate_identifier_0, statement.range, existedTypeAlias.declaration.range, name);
  ...
  private compileIfStatement(statement: IfStatement): ExpressionRef {
    ...
    switch (condKind) {
      ...
      case ConditionKind.False: {
        return ifFalse ? module.block(null, [module.drop(condExprTrueish), this.compileStatement(ifFalse)]) : module.drop(condExprTrueish);
      }
    }
  ...
  private compileReturnStatement(statement: ReturnStatement): ExpressionRef {
    ...
    return expr ? (this.currentType == Type.void ? module.block(null, [expr, module.return()]) : module.return(expr)) : module.return();
  }
  ...
  private compileSwitchStatement(statement: SwitchStatement): ExpressionRef {
    ...
    let condExpr = this.compileExpression(statement.condition, Type.u32, Constraints.ConvImplicit);
    ...
    for (let i = 0; i < numCases; ++i) {
      ...
      breaks[breakIndex++] = module.br(
        ...
        module.binary(
          ...
          this.compileExpression(assert(case_.label), Type.u32, Constraints.ConvImplicit),
        ),
      );
    }
  ...
  private compileVariableStatement(statement: VariableStatement): ExpressionRef {
    ...
    for (let i = 0; i < numDeclarations; ++i) {
        ...
        if (initExpr) {
          ...
          if (precomp) {
            ...
            switch (<u32>getExpressionType(initExpr)) {
              ...
              case <u32>TypeRef.I64: {
                local = new Local(name, -1, type, flow.targetFunction);
                local.setConstantIntegerValue(i64_new(getConstValueI64Low(initExpr), getConstValueI64High(initExpr)), type);
                break;
              }
              case <u32>TypeRef.F32: {
                local = new Local(name, -1, type, flow.targetFunction);
            ...
            if (local) {
              ...
              if (!scopedLocals) flow.scopedLocals = scopedLocals = new Map();
                ...
                this.errorRelated(DiagnosticCode.Duplicate_identifier_0, declaration.name.range, existing.declaration.name.range, name);
                return this.module.unreachable();
              }
      ...
      if (!isStatic) {
        let local: Local;
        if (declaration.isAny(CommonFlags.Let | CommonFlags.Const) || flow.isInline) {
          // here: not top-level
          let existingLocal = flow.getScopedLocal(name);
          if (existingLocal) {
            if (!existingLocal.declaration.range.source.isNative) {
              this.errorRelated(DiagnosticCode.Duplicate_identifier_0, declaration.name.range, existingLocal.declaration.name.range, name);
            } else {
  ...
  compileInlineConstant(element: VariableLikeElement, contextualType: Type, constraints: Constraints): ExpressionRef {
    ...
    switch (type.kind) {
      ...
      case TypeKind.I16: {
        ...
        return this.module.i32(element.constantValueKind == ConstantValueKind.Integer ? (i64_low(element.constantIntegerValue) << shift) >> shift : 0); // recognized by canOverflow
      }
      case TypeKind.U8:
      case TypeKind.U16: {
        let mask = element.type.computeSmallIntegerMask(Type.i32);
        return this.module.i32(element.constantValueKind == ConstantValueKind.Integer ? i64_low(element.constantIntegerValue) & mask : 0); // recognized by canOverflow
      }
      case TypeKind.I32:
      case TypeKind.U32: {
        return this.module.i32(element.constantValueKind == ConstantValueKind.Integer ? i64_low(element.constantIntegerValue) : 0);
      }
      case TypeKind.Isize:
      case TypeKind.Usize: {
  ...
  compileExpression(expression: Expression, contextualType: Type, constraints: Constraints = Constraints.None): ExpressionRef {
    ...
    switch (expression.kind) {
      ...
      case NodeKind.Class: {
        ...
        this.error(DiagnosticCode.Not_implemented_0, expression.range, "Block-scoped class declarations or expressions");
  ...
  convertExpression(
    ...
    if (!fromType.isAssignableTo(toType)) {
      if (!explicit) {
        this.error(DiagnosticCode.Conversion_from_type_0_to_1_requires_an_explicit_cast, reportNode.range, fromType.toString(), toType.toString()); // recoverable
      }
    }
  ...
  private compileAssertionExpression(expression: AssertionExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
  ...
  private compileCommutativeCompareBinaryExpression(expression: BinaryExpression, contextualType: Type): ExpressionRef {
    ...
    if (leftOverload) {
      return this.compileCommutativeBinaryOverload(leftOverload, left, leftExpr, leftType, right, rightExpr, rightType, expression);
    }
    if (rightOverload) {
      return this.compileCommutativeBinaryOverload(rightOverload, right, rightExpr, rightType, left, leftExpr, leftType, expression);
    }
    const signednessIsRelevant = false;
    commonType = Type.commonType(leftType, rightType, contextualType, signednessIsRelevant);
    if (!commonType) {
      this.error(DiagnosticCode.Operator_0_cannot_be_applied_to_types_1_and_2, expression.range, operatorString, leftType.toString(), rightType.toString());
      this.currentType = contextualType;
      return module.unreachable();
    }
    ...
    if (commonType.isFloatValue) {
      if (isConstExpressionNaN(module, rightExpr) || isConstExpressionNaN(module, leftExpr)) {
        this.warning(DiagnosticCode._NaN_does_not_compare_equal_to_any_other_value_including_itself_Use_isNaN_x_instead, expression.range);
      }
      if (isConstNegZero(rightExpr) || isConstNegZero(leftExpr)) {
        this.warning(DiagnosticCode.Comparison_with_0_0_is_sign_insensitive_Use_Object_is_x_0_0_if_the_sign_matters, expression.range);
      }
    }
  ...
  /** compile `>` `>=` `<` `<=` BinaryExpression */
  private compileNonCommutativeCompareBinaryExpression(expression: BinaryExpression, contextualType: Type): ExpressionRef {
    let module = this.module;
    let left = expression.left;
    let right = expression.right;
    let leftExpr: ExpressionRef;
  ...
  private compileBinaryExpression(expression: BinaryExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let left = expression.left;
    let right = expression.right;
      ...
      case Token.Plus: {
        ...
        if (compound) {
          if (!leftType.isNumericValue) {
            this.error(DiagnosticCode.The_0_operator_cannot_be_applied_to_type_1, expression.range, "+", leftType.toString());
            return module.unreachable();
          }
          ...
          if (!commonType || !commonType.isNumericValue) {
            this.error(DiagnosticCode.Operator_0_cannot_be_applied_to_types_1_and_2, expression.range, "+", leftType.toString(), rightType.toString());
            this.currentType = contextualType;
            return module.unreachable();
          }
          leftExpr = this.convertExpression(leftExpr, leftType, commonType, false, left);
    ...
    if (!this.currentType.isStrictlyAssignableTo(targetType)) {
      this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, expression.range, this.currentType.toString(), targetType.toString());
      return module.unreachable();
    }
  ...
  makePow(leftExpr: ExpressionRef, rightExpr: ExpressionRef, type: Type, reportNode: Node): ExpressionRef {
    ...
    switch (type.kind) {
      case TypeKind.Bool: {
        return module.select(module.i32(1), module.binary(BinaryOp.EqI32, rightExpr, module.i32(0)), leftExpr, TypeRef.I32);
      }
      case TypeKind.I8:
      case TypeKind.U8:
      case TypeKind.I16:
  ...
  makeShl(leftExpr: ExpressionRef, rightExpr: ExpressionRef, type: Type): ExpressionRef {
    ...
    switch (type.kind) {
      ...
      case TypeKind.U16: {
        ...
        return module.binary(BinaryOp.ShlI32, leftExpr, module.binary(BinaryOp.AndI32, rightExpr, module.i32(type.size - 1)));
      }
      case TypeKind.I32:
      case TypeKind.U32:
  ...
  private compileUnaryOverload(operatorInstance: Function, value: Expression, valueExpr: ExpressionRef, reportNode: Node): ExpressionRef {
  ...
  private compileAssignment(expression: Expression, valueExpression: Expression, contextualType: Type): ExpressionRef {
    ...
    switch (target.kind) {
      ...
      case ElementKind.Property: {
        ...
        if (!setterInstance) {
          this.error(DiagnosticCode.Cannot_assign_to_0_because_it_is_a_constant_or_a_read_only_property, expression.range, propertyInstance.internalName);
          return this.module.unreachable();
        }
      ...
      case ElementKind.IndexSignature: {
        ...
        if (!indexedSet) {
          ...
          if (!indexedGet) {
            this.error(DiagnosticCode.Index_signature_is_missing_in_type_0, expression.range, classInstance.internalName);
          } else {
            this.error(DiagnosticCode.Index_signature_in_type_0_only_permits_reading, expression.range, classInstance.internalName);
          }
          return this.module.unreachable();
        }
      ...
      default: {
        this.error(DiagnosticCode.Cannot_assign_to_0_because_it_is_a_constant_or_a_read_only_property, expression.range, target.internalName);
        return this.module.unreachable();
      }
    }
    ...
    switch (target.kind) {
      case ElementKind.Local: {
        ...
        if (flow.isLocalFlag(local.index, LocalFlags.Constant, true)) {
          this.error(DiagnosticCode.Cannot_assign_to_0_because_it_is_a_constant_or_a_read_only_property, valueExpression.range, target.internalName);
      ...
      case ElementKind.Property: {
        ...
        if (propertyInstance.is(CommonFlags.Instance)) {
          ...
          let thisExpr = this.compileExpression(assert(thisExpression), thisType, Constraints.ConvImplicit | Constraints.IsThis);
          ...
          let ret = module.block(
            null,
            [
              this.makeCallDirect(setterInstance, [thisExpr, module.local_tee(tempLocal.index, valueExpr, valueType.isManaged, valueTypeRef)], valueExpression),
          ...
          let ret = module.block(
            null,
            [
              this.makeCallDirect(setterInstance, [module.local_tee(tempLocal.index, valueExpr, valueType.isManaged, valueTypeRef)], valueExpression),
              module.local_get(tempLocal.index, valueTypeRef),
            ],
            valueTypeRef,
          );
      ...
      case ElementKind.IndexSignature: {
        ...
        if (!getterInstance) {
          this.error(DiagnosticCode.Index_signature_is_missing_in_type_0, valueExpression.range, classInstance.internalName);
          return module.unreachable();
        }
        let setterInstance = classInstance.lookupOverload(OperatorKind.IndexedSet, isUnchecked);
        if (!setterInstance) {
          this.error(DiagnosticCode.Index_signature_in_type_0_only_permits_reading, valueExpression.range, classInstance.internalName);
        ...
        if (tee) {
          ...
          let ret = module.block(
            ...
            [
              ...
              this.makeCallDirect(
                getterInstance,
                [module.local_get(tempTarget.index, tempTarget.type.toRef()), module.local_get(tempElement.index, tempElement.type.toRef())],
                valueExpression,
              ),
            ],
            returnType.toRef(),
      ...
      default: {
        this.error(DiagnosticCode.The_target_of_an_assignment_must_be_a_variable_or_a_property_access, valueExpression.range);
      }
    }
    return module.unreachable();
  }
  ...
  private compileCallExpression(
    ...
    if (expression.expression.kind == NodeKind.Super) {
      ...
      if (!sourceFunction.is(CommonFlags.Constructor)) {
        this.error(DiagnosticCode.Super_calls_are_not_permitted_outside_constructors_or_in_nested_functions_inside_constructors, expression.range);
        return module.unreachable();
      }
      ...
      let superCall = this.compileCallDirect(baseCtorInstance, expression.args, expression, module.local_get(thisLocal.index, sizeTypeRef));

      // check that super had been called before accessing `this`
      if (flow.isAny(FlowFlags.AccessesThis | FlowFlags.ConditionallyAccessesThis)) {
        this.error(DiagnosticCode._super_must_be_called_before_accessing_this_in_the_constructor_of_a_derived_class, expression.range);
        return module.unreachable();
      }
    ...
    switch (target.kind) {
      ...
      case ElementKind.Function: {
        ...
        if (functionInstance.is(CommonFlags.Instance)) {
          thisArg = this.compileExpression(assert(thisExpression), assert(functionInstance.signature.thisType), Constraints.ConvImplicit | Constraints.IsThis);
        }
    ...
    if (signature) {
      return this.compileCallIndirect(signature, functionArg, expression.args, expression, 0, contextualType == Type.void);
    }
    this.error(
  ...
  private compileCallExpressionBuiltin(prototype: FunctionPrototype, expression: CallExpression, contextualType: Type): ExpressionRef {
  ...
  checkCallSignature(signature: Signature, numArguments: i32, hasThis: bool, reportNode: Node): bool {
    ...
    if (hasRest) {
      this.error(DiagnosticCode.Not_implemented_0, reportNode.range, "Rest parameters");
      return false;
    }
    ...
    if (numArguments < minimum) {
      this.error(
        minimum < maximum ? DiagnosticCode.Expected_at_least_0_arguments_but_got_1 : DiagnosticCode.Expected_0_arguments_but_got_1,
        reportNode.range,
        minimum.toString(),
    ...
    if (numArguments > maximum && !hasRest) {
      this.error(DiagnosticCode.Expected_0_arguments_but_got_1, reportNode.range, maximum.toString(), numArguments.toString());
      return false;
    }
  ...
  compileCallDirect(
    ...
    if (instance.hasDecorator(DecoratorFlags.Inline) && (!instance.is(CommonFlags.Overridden) || reportNode.isAccessOnSuper)) {
      ...
      if (inlineStack.includes(instance)) {
        this.warning(DiagnosticCode.Function_0_cannot_be_inlined_into_itself, reportNode.range, instance.internalName);
      } else {
        let parameterTypes = signature.parameterTypes;
  ...
  makeCallInline(instance: Function, operands: ExpressionRef[] | null, thisArg: ExpressionRef = 0, immediatelyDropped: bool = false): ExpressionRef {
    let module = this.module;
    ...
    for (let i = 0; i < numArguments; ++i) {
      ...
      body.push(module.local_set(argumentLocal.index, paramExpr, paramType.isManaged));
    ...
    for (let i = numArguments; i < numParameters; ++i) {
      ...
      let initExpr = this.compileExpression(assert(instance.prototype.functionTypeNode.parameters[i].initializer), initType, Constraints.ConvImplicit);
  ...
  ensureOverrideStub(original: Function): Function {
    ...
    let module = this.module;
    stub.ref = module.addFunction(stub.internalName, stub.signature.paramRefs, stub.signature.resultRefs, null, module.unreachable());
  ...
  private finalizeOverrideStub(instance: Function): void {
    ...
    if (overrideInstances) {
      ...
      for (let i = 0, k = overrideInstances.length; i < k; ++i) {
        ...
        let calledName = needsVarargsStub ? this.ensureVarargsStub(overrideInstance).internalName : overrideInstance.internalName;
        ...
        if (extenders) {
          for (let _values = Set_values(extenders), i = 0, k = _values.length; i < k; ++i) {
            ...
            if (!mostRecentInheritanceMapping.has(extender) || !assert(mostRecentInheritanceMapping.get(extender)).extends(classInstance)) {
  ...
  makeCallDirect(instance: Function, operands: ExpressionRef[] | null, reportNode: Node, immediatelyDropped: bool = false): ExpressionRef {
    if (instance.hasDecorator(DecoratorFlags.Inline)) {
      if (!instance.is(CommonFlags.Overridden)) {
        ...
        this.warning(DiagnosticCode.Function_0_is_virtual_and_will_not_be_inlined, reportNode.range, instance.internalName);
      }
    }
    let module = this.module;
  ...
  makeCallIndirect(
    ...
    if (getSideEffects(functionArg, module.ref) & SideEffects.WritesGlobal) {
      ...
      // simplify
      functionArg = module.block(null, [module.global_set(argumentsLength, module.i32(numArguments)), functionArg], sizeTypeRef);
    }
  ...
  private compileCommaExpression(expression: CommaExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
  ...
  private compileElementAccessExpression(expression: ElementAccessExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    ...
    if (targetType) {
      ...
      this.error(DiagnosticCode.Index_signature_is_missing_in_type_0, expression.expression.range, targetType.toString());
    }
    return module.unreachable();
  }

  private compileFunctionExpression(expression: FunctionExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    ...
    let prototype = new FunctionPrototype(
      isSemanticallyAnonymous ? `${isNamed ? declaration.name.text : "anonymous"}|${sourceFunction.nextAnonymousId++}` : declaration.name.text,
      sourceFunction,
      declaration,
      DecoratorFlags.None,
    );
    ...
    if (contextualSignature) {
      ...
      if (numPresentParameters > numParameters) {
        this.error(DiagnosticCode.Expected_0_arguments_but_got_1, expression.range, numParameters.toString(), numPresentParameters.toString());
        return module.unreachable();
      }
      ...
      for (let i = 0; i < numPresentParameters; ++i) {
        ...
        if (!isTypeOmitted(parameterNode.type)) {
          let resolvedType = this.resolver.resolveType(parameterNode.type, flow, sourceFunction.parent, contextualTypeArguments);
          if (!resolvedType) return module.unreachable();
          if (!parameterTypes[i].isStrictlyAssignableTo(resolvedType)) {
            this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, parameterNode.range, parameterTypes[i].toString(), resolvedType.toString());
            return module.unreachable();
          }
        }
      ...
      if (!isTypeOmitted(signatureNode.returnType)) {
        let resolvedType = this.resolver.resolveType(signatureNode.returnType, flow, sourceFunction.parent, contextualTypeArguments);
        if (!resolvedType) return module.unreachable();
        if (returnType == Type.void ? resolvedType != Type.void : !resolvedType.isStrictlyAssignableTo(returnType)) {
          this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, signatureNode.returnType.range, resolvedType.toString(), returnType.toString());
          return module.unreachable();
        }
      }
      ...
      if (thisTypeNode) {
        ...
        let resolvedType = this.resolver.resolveType(thisTypeNode, flow, sourceFunction.parent, contextualTypeArguments);
        if (!resolvedType) return module.unreachable();
        if (!thisType.isStrictlyAssignableTo(resolvedType)) {
          this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, thisTypeNode.range, thisType.toString(), resolvedType.toString());
          return module.unreachable();
        }
      }
    ...
    if (!isSemanticallyAnonymous) {
      ...
      if (existingLocal) {
        if (!existingLocal.declaration.range.source.isNative) {
          this.errorRelated(DiagnosticCode.Duplicate_identifier_0, declaration.name.range, existingLocal.declaration.name.range, fname);
        } else {
          // scoped locals are shared temps that don't track declarations
  ...
  private compileIdentifierExpression(expression: IdentifierExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let flow = this.currentFlow;
    let sourceFunction = flow.sourceFunction;
    ...
    switch (expression.kind) {
      case NodeKind.Null: {
        ...
        this.warning(DiagnosticCode.Expression_resolves_to_unusual_type_0, expression.range, this.currentType.toString());
        return options.isWasm64 ? module.i64(0) : module.i32(0);
      }
      case NodeKind.True: {
        this.currentType = Type.bool;
      ...
      case NodeKind.Super: {
        if (sourceFunction.is(CommonFlags.Constructor)) {
          if (flow.is(FlowFlags.CtorParamContext)) {
            ...
            this.error(DiagnosticCode._super_must_be_called_before_accessing_a_property_of_super_in_the_constructor_of_a_derived_class, expression.range);
          }
        }
        if (flow.isInline) {
    ...
    switch (target.kind) {
      ...
      case ElementKind.FunctionPrototype: {
        ...
        let functionInstance = this.resolver.resolveFunction(functionPrototype, null, cloneMap(flow.contextualTypeArguments));
  ...
  private compileIdentifierExpressionBuiltin(element: VariableLikeElement, expression: IdentifierExpression, contextualType: Type): ExpressionRef {
  ...
  private compileInstanceOfExpression(expression: InstanceOfExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let flow = this.currentFlow;
    ...
    let expectedType = this.resolver.resolveType(expression.isType, flow, flow.sourceFunction, cloneMap(flow.contextualTypeArguments));
    if (!expectedType) {
      this.currentType = Type.bool;
      return this.module.unreachable();
    }
  ...
  private makeInstanceofType(expression: InstanceOfExpression, expectedType: Type): ExpressionRef {
    ...
    if (actualType.isNullableReference && !expectedType.isNullableReference) {
      ...
      if (actualType.nonNullableType.isAssignableTo(expectedType)) {
        return module.binary(sizeTypeRef == TypeRef.I64 ? BinaryOp.NeI64 : BinaryOp.NeI32, expr, this.makeZero(actualType));
      }
      ...
      if (actualType.nonNullableType.hasSubtypeAssignableTo(expectedType)) {
        if (!(actualType.isUnmanaged || expectedType.isUnmanaged)) {
          ...
          let tempIndex = temp.index;
          return module.if(
            module.unary(sizeTypeRef == TypeRef.I64 ? UnaryOp.EqzI64 : UnaryOp.EqzI32, module.local_tee(tempIndex, expr, actualType.isManaged)),
            module.i32(0),
            module.call(this.prepareInstanceOf(expectedType.classReference!), [module.local_get(tempIndex, sizeTypeRef)], TypeRef.I32),
          );
        } else {
          this.error(
  ...
  private finalizeInstanceOf(
    ...
    if (allInstances) {
      for (let _values = Set_values(allInstances), i = 0, k = _values.length; i < k; ++i) {
        ...
        stmts.push(module.br("is_instance", module.binary(BinaryOp.EqI32, module.local_get(1, TypeRef.I32), module.i32(instance.id))));
      }
    }
  ...
  private compileTemplateLiteral(expression: TemplateLiteralExpression, constraints: Constraints): ExpressionRef {
    ...
    if (!tag) {
      ...
      for (let i = 0; i < numExpressions; ++i) {
        ...
        temps[i] = temp;
        stmts[i] = module.local_set(temp.index, this.makeToString(this.compileExpression(expression, stringType), this.currentType, expression), true);
      }
      // Populate the static array with the toString'ed subexpressions and call .join("")
      for (let i = 0; i < numExpressions; ++i) {
        stmts[numExpressions + i] = this.makeCallDirect(
          indexedSetInstance,
          [module.usize(offset), module.i32(expressionPositions[i]), module.local_get(temps[i].index, stringType.toRef())],
          expression,
        );
      }
      stmts[2 * numExpressions] = this.makeCallDirect(joinInstance, [module.usize(offset), this.ensureStaticString("")], expression);
    ...
    if (arrayInstance == tsaArrayInstance) {
      ...
      arraySegment = this.addStaticArrayHeader(stringType, this.addStaticBuffer(this.options.usizeType, partExprs), arrayInstance);
      let rawHeaderSegment = this.addStaticArrayHeader(stringType, this.addStaticBuffer(this.options.usizeType, rawExprs));
      arrayInstance.writeField("raw", i64_add(rawHeaderSegment.offset, i64_new(this.program.totalOverhead)), arraySegment.buffer);
    } else {
      arraySegment = this.addStaticArrayHeader(stringType, this.addStaticBuffer(this.options.usizeType, partExprs), arrayInstance);
    }
    ...
    args.unshift(
      Node.createCompiledExpression(module.usize(i64_add(arraySegment.offset, i64_new(this.program.totalOverhead))), arrayInstance.type, Source.native.range),
    );
  ...
  private compileArrayLiteral(expression: ArrayLiteralExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let flow = this.currentFlow;
    let program = this.program;
    ...
    if (isStatic) {
      ...
      if (constraints & Constraints.PreferStatic) {
        ...
        return program.options.isWasm64 ? this.module.i64(i64_low(arrayAddress), i64_high(arrayAddress)) : this.module.i32(i64_low(arrayAddress));
    ...
    if (!indexedSet) {
      this.error(DiagnosticCode.Index_signature_in_type_0_only_permits_reading, expression.range, arrayInstance.internalName);
      this.currentType = arrayType;
      return module.unreachable();
    }
    ...
    stmts.push(module.local_set(tempThis.index, this.makeNewArray(arrayInstance, length, i64_new(0), expression), arrayType.isManaged));
    ...
    stmts.push(
      module.local_set(
        tempDataStart.index,
        module.load(arrayType.byteSize, false, module.local_get(tempThis.index, arrayTypeRef), arrayTypeRef, dataStartProperty.memoryOffset),
        true, // ArrayBuffer
      ),
    );
    for (let i = 0; i < length; ++i) {
      // this[i] = value
      stmts.push(module.call(indexedSet.internalName, [module.local_get(tempThis.index, arrayTypeRef), module.i32(i), values[i]], TypeRef.None));
    }
    // -> tempThis
  ...
  private compileStaticArrayLiteral(expression: ArrayLiteralExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let flow = this.currentFlow;
    let program = this.program;
    ...
    if (isStatic) {
      ...
      if (constraints & Constraints.PreferStatic) {
        let expr = this.options.isWasm64 ? module.i64(i64_low(bufferAddress), i64_high(bufferAddress)) : module.i32(i64_low(bufferAddress));
        this.currentType = arrayType;
        return expr;
    ...
    stmts.push(
      module.local_set(
        tempThis.index,
        this.makeCallDirect(program.newBufferInstance, [isWasm64 ? module.i64(bufferSize) : module.i32(bufferSize), module.i32(arrayInstance.id)], expression),
        arrayType.isManaged,
      ),
    );
    for (let i = 0; i < length; ++i) {
  ...
  private compileObjectLiteral(expression: ObjectLiteralExpression, contextualType: Type): ExpressionRef {
    ...
    let classReference = contextualType.getClass();
    if (!classReference) {
      this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, expression.range, "<object>", contextualType.toString());
      return module.unreachable();
    }
    ...
    for (let i = 0; i < numNames; ++i) {
      ...
      if (!member || member.kind != ElementKind.PropertyPrototype) {
        this.error(DiagnosticCode.Property_0_does_not_exist_on_type_1, names[i].range, memberName, classType.toString());
        hasErrors = true;
        continue;
      }
      if (member.is(CommonFlags.Private)) {
        this.error(DiagnosticCode.Property_0_is_private_and_only_accessible_within_class_1, names[i].range, memberName, classType.toString());
        hasErrors = true;
        continue;
      }
      ...
      let setterInstance = propertyInstance.setterInstance;
      if (!setterInstance) {
        this.error(DiagnosticCode.Cannot_assign_to_0_because_it_is_a_constant_or_a_read_only_property, names[i].range, memberName, classType.toString());
        hasErrors = true;
        continue;
      }
      ...
      let expr = this.makeCallDirect(
        setterInstance,
        [module.local_get(tempLocal.index, classTypeRef), this.compileExpression(values[i], propertyType, Constraints.ConvImplicit)],
    ...
    for (let i = 0, k = deferredProperties.length; i < k; ++i) {
      ...
      exprs.push(
        this.makeCallDirect(
          setterInstance,
          [module.local_get(tempLocal.index, classTypeRef), this.compileExpression(values[i], propertyInstance.type, Constraints.ConvImplicit)],
          setterInstance.identifierNode,
        ),
      );
    }
    ...
    exprs.unshift(module.local_set(tempLocal.index, this.compileInstantiate(ctor, [], Constraints.None, expression), classType.isManaged));
  ...
  private compileNewExpression(expression: NewExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let flow = this.currentFlow;
    ...
    if (
      ...
      classInstance = this.resolver.resolveClass(classPrototype, classReference.typeArguments, cloneMap(flow.contextualTypeArguments));
    } else {
  ...
  ensureConstructor(
    ...
    if (instance) {
      ...
      if (baseClass) {
        ...
        instance = new Function(
          ...
          new FunctionPrototype(
            CommonNames.constructor,
            classInstance, // bound
            this.program.makeNativeFunctionDeclaration(CommonNames.constructor, CommonFlags.Instance | CommonFlags.Constructor),
          ),
          null,
      ...
      let funcRef = module.addFunction(instance.internalName, signature.paramRefs, signature.resultRefs, varTypes, module.flatten(stmts, sizeTypeRef));
      instance.finalize(module, funcRef);
    }
  ...
  compileInstantiate(
    ...
    let expr = this.compileCallDirect(ctorInstance, argumentExpressions, reportNode, this.makeZero(this.options.usizeType), constraints);
  ...
  private compilePropertyAccessExpression(expression: PropertyAccessExpression, ctxType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let flow = this.currentFlow;
    ...
    switch (target.kind) {
      ...
      case ElementKind.Property: {
        ...
        if (getterInstance.is(CommonFlags.Instance)) {
          thisArg = this.compileExpression(assert(thisExpression), assert(getterInstance.signature.thisType), Constraints.ConvImplicit | Constraints.IsThis);
        }
  ...
  private compileTernaryExpression(expression: TernaryExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    ...
    if (contextualType == Type.void) {
      ...
      if (!commonType) {
        this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, ifElse.range, ifElseType.toString(), ifThenType.toString());
        this.currentType = contextualType;
        return module.unreachable();
      }
  ...
  private compileUnaryPostfixExpression(expression: UnaryPostfixExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let flow = this.currentFlow;
    ...
    switch (expression.operator) {
      case Token.Plus_Plus: {
        ...
        if (!this.currentType.isValue) {
          this.error(DiagnosticCode.The_0_operator_cannot_be_applied_to_type_1, expression.range, "++", this.currentType.toString());
          return module.unreachable();
        }
  ...
  private compileUnaryPrefixExpression(expression: UnaryPrefixExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let module = this.module;
    let compound = false;
    let expr: ExpressionRef;
  ...
  private compileTypeof(expression: UnaryPrefixExpression, contextualType: Type, constraints: Constraints): ExpressionRef {
    let operand = expression.operand;
    let expr: ExpressionRef = 0;
    let stringInstance = this.program.stringInstance;
    ...
    if (operand.kind == NodeKind.Null) {
      ...
      if (!element) {
        switch (operand.kind) {
          ...
          case NodeKind.PropertyAccess:
          case NodeKind.ElementAccess: {
            operand = operand.kind == NodeKind.PropertyAccess ? (<PropertyAccessExpression>operand).expression : (<ElementAccessExpression>operand).expression;
    ...
    this.currentType = stringInstance.type;
    return expr ? this.module.block(null, [expr, this.ensureStaticString(typeString)], this.options.sizeTypeRef) : this.ensureStaticString(typeString);
  }
    ...
    switch (type.kind) {
      ...
      case TypeKind.F32: {
        ...
        if (options.shrinkLevelHint > 1 && options.hasFeature(Feature.NontrappingF2I)) {
          ...
          return module.unary(
            UnaryOp.EqzI32,
            module.unary(UnaryOp.EqzI32, module.unary(UnaryOp.TruncSatF32ToU32, module.unary(UnaryOp.CeilF32, module.unary(UnaryOp.AbsF32, expr)))),
          );
        } else {
      ...
      case TypeKind.F64: {
        ...
        if (options.shrinkLevelHint > 1 && options.hasFeature(Feature.NontrappingF2I)) {
          ...
          return module.unary(
            UnaryOp.EqzI32,
            module.unary(UnaryOp.EqzI32, module.unary(UnaryOp.TruncSatF64ToU32, module.unary(UnaryOp.CeilF64, module.unary(UnaryOp.AbsF64, expr)))),
          );
        } else {
          // 0 < abs(bitCast(x)) <= bitCast(Infinity) or
      ...
      case TypeKind.Void:
      default: {
        this.error(DiagnosticCode.An_expression_of_type_0_cannot_be_tested_for_truthiness, reportNode.range, type.toString());
        return module.i32(0);
      }
    }
  }
  ...
  makeToString(expr: ExpressionRef, type: Type, reportNode: Node): ExpressionRef {
    ...
    if (classType) {
      ...
      if (toStringInstance) {
        ...
        if (!type.isStrictlyAssignableTo(assert(toStringSignature.thisType))) {
          this.errorRelated(DiagnosticCode.The_this_types_of_each_signature_are_incompatible, reportNode.range, toStringInstance.identifierAndSignatureRange);
          this.currentType = stringType;
          return this.module.unreachable();
        }
    ...
    this.error(DiagnosticCode.Type_0_is_not_assignable_to_type_1, reportNode.range, type.toString(), stringType.toString());
    this.currentType = stringType;
    return this.module.unreachable();
  }
  ...
  makeAllocation(classInstance: Class): ExpressionRef {
    ...
    if (classInstance.hasDecorator(DecoratorFlags.Unmanaged)) {
      ...
      return module.call(
        ...
        [options.isWasm64 ? module.i64(classInstance.nextMemoryOffset) : module.i32(classInstance.nextMemoryOffset), module.i32(classInstance.id)],
        options.sizeTypeRef,
      );
    }
  }
  ...
  makeConditionalAllocation(classInstance: Class, thisIndex: i32): ExpressionRef {
    ...
    return module.if(
      module.unary(classTypeRef == TypeRef.I64 ? UnaryOp.EqzI64 : UnaryOp.EqzI32, module.local_get(thisIndex, classTypeRef)),
    ...
    for (let _values = Map_values(members), i = 0, k = _values.length; i < k; ++i) {
      ...
      let expr = this.makeCallDirect(
        ...
        [
          ...
          module.local_get(
            isInline ? flow.lookupLocal(property.name)!.index : 1 + parameterIndex, // `this` is local 0
            fieldTypeRef,
          ),
        ],
        setterInstance.identifierNode,
  ...
  makeStaticAbort(
    ...
    return module.block(null, [
      module.call(abortInstance.internalName, [messageExpr, filenameExpr, module.i32(source.lineAt(range.start)), module.i32(source.columnAt())], TypeRef.None),
      module.unreachable(),
    ]);
  }
  ...
  makeRuntimeNonNullCheck(
    ...
    let staticAbortCallExpr = this.makeStaticAbort(this.ensureStaticString("Unexpected 'null' (not assigned or failed cast)"), reportNode); // TODO: throw
    ...
    if (type.isExternalReference) {
      ...
      expr = module.if(module.local_tee(tempIndex, expr, type.isManaged), module.local_get(tempIndex, type.toRef()), staticAbortCallExpr);
    }
    this.currentType = type.nonNullableType;
    return expr;
  }
  ...
  makeRuntimeDowncastCheck(
    ...
    if (!toType.isNullableReference || flow.isNonnull(expr, type)) {
      ...
      expr = module.if(
        module.call(this.prepareInstanceOf(toType.classReference!), [module.local_tee(tempIndex, expr, type.isManaged)], TypeRef.I32),
      ...
      expr = module.if(
        ...
        module.usize(0),
        module.if(
          module.call(this.prepareInstanceOf(toType.classReference!), [module.local_get(tempIndex, type.toRef())], TypeRef.I32),
          module.local_get(tempIndex, type.toRef()),
          staticAbortCallExpr,
        ),
      );
...
function mangleImportName(element: Element, declaration: DeclarationStatement): void {
  ...
  mangleImportName_elementName = mangleInternalName(element.name, element.parent, element.is(CommonFlags.Instance), true);

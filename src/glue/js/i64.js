...
globalThis.i64_is_i8 = function i64_is_i8(value) {
  return (value.high === 0 && value.low >= 0 && value.low <= i8.MAX_VALUE) || (value.high === -1 && value.low >= i8.MIN_VALUE && value.low < 0);
};

globalThis.i64_is_i16 = function i64_is_i16(value) {
  return (value.high === 0 && value.low >= 0 && value.low <= i16.MAX_VALUE) || (value.high === -1 && value.low >= i16.MIN_VALUE && value.low < 0);
};
